...
class User extends Model{
    ...
    public function delete(){
        ...
        $sql->queryExec("CALL sp_users_delete(:iduser)", array(
            ":iduser"=>$this->getiduser()
        ));
    }
    ...
    public static function getForgot($email, $inadmin = true){
        ...
        if(count($results) === 0){
            ...
            if(count($results2)===0){
                ...
                /*
                ATENÇÃO!
                Sistema de envio de email não está operando, necessária algumas mudanças devido a atualização
                do phpmailer
    ...
    public static function setForgotUsed($idrecovery){
        ...
        $sql->queryExec("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = :idrecovery", array(
            ":idrecovery"=>$idrecovery
        ));
    }
    ...
    public function setPassword($password){
        ...
        $sql->queryExec("UPDATE tb_users SET despassword = :password WHERE iduser = :iduser", array(
            ":password"=>$password,
            ":iduser"=>$this->getiduser()
        ));
    }
